...
class AutoClickService : AccessibilityService() {
    ...
    /**
     * Best-effort read of which app is currently in front. Used so Play can tell whether
     * a target's linked app is already on screen, or needs to be launched first.
     * Returns null if it can't be determined (e.g. mid-transition).
     */
